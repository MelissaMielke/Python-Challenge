...
This assignment was completed in conjunction with my *Data Visualization & Analytics* Boot Camp program. The assignment consists of two *real-world* Python coding challenges, named **PyBank** and **PyPoll**.

### Navigation:

 - Local parent directory and corresponding remote repo named ***Python-Challenge***
 - 2 sub-directories, one per challenge, named ***PyBank** & **PyPoll***
 - Single file `main.py` within each challenge sub-directory contains code written to meet assignment requirements
